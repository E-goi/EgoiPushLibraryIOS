#
#  Be sure to run `pod spec lint EgoiPushLibrary.podspec' to ensure this is a
...
This library is responsible for handling all matter related to Push Notifications received from E-goi.
  ...
  spec.homepage     = "https://github.com/JoaoCGS/EgoiPushLibrary"
  ...
  spec.author             = { "João Silva" => "jsilva@e-goi.com" }
  # Or just: spec.author    = "João Silva"
  # spec.authors            = { "João Silva" => "jsilva@e-goi.com" }
  # spec.social_media_url   = "https://twitter.com/João Silva"
  ...
  spec.source       = { :git => "https://github.com/JoaoCGS/EgoiPushLibrary.git", :tag => "#{spec.version}" }
